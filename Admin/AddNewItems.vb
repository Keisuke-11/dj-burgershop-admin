    ...
    Private Sub LoadIngredientDetailsForEdit()
        Try
            ...
            Dim sql As String = "
                ...
                GROUP BY i.IngredientName, i.UnitType, i.ReorderLevel, i.Category, i.CreatedDate
            "
            ...
            Dim categoryName As String = If(reader.IsDBNull(reader.GetOrdinal("Category")), "", reader("Category").ToString())
            ...
            If Not reader.IsDBNull(reader.GetOrdinal("ReorderLevel")) Then
                minStock = Convert.ToDecimal(reader("ReorderLevel"))
            End If
        ...
        Try
            ...
            Try
                ...
                Dim sqlCheck As String = "
                    SELECT IngredientID 
                    FROM ingredients 
                    WHERE LOWER(IngredientName) = LOWER(@name) AND Status = 'Active'
                "
                ...
                If existingID IsNot Nothing Then
                    ...
                    ' Update reorder level if needed
                ...
                Else
                    ...
                    Dim sqlInsertIngredient As String = "
                        INSERT INTO ingredients (
                            IngredientName, Category, UnitType,
                    ...
                    cmdInsert.Parameters.AddWithValue("@category", Category.Text)
