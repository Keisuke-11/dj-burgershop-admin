...
Public Class FormEditPayroll
    ...
    Private Sub CalculateNetPay()
        Try
            ...
            Dim netPay As Decimal = basic + overtime - deductions
    ...
    Private Sub txtAmount_TextChanged(sender As Object, e As EventArgs) Handles txtBasicSalary.TextChanged, txtOvertime.TextChanged, txtDeductions.TextChanged
        CalculateNetPay()
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            cmd.Parameters.AddWithValue("@net", (Convert.ToDecimal(txtBasicSalary.Text) + Convert.ToDecimal(txtOvertime.Text) - Convert.ToDecimal(txtDeductions.Text)))
            cmd.Parameters.AddWithValue("@id", payrollID)
            ...
            ' Refresh parent form
            If Application.OpenForms().OfType(Of FormPayroll).Any() Then
                Application.OpenForms().OfType(Of FormPayroll)().First().LoadEmployees()
            End If
