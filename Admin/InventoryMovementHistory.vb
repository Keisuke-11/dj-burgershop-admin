...
Public Class InventoryMovementHistory
    ...
    ' NEW METHOD: Load Total Cost - Calculates overall total from ALL data in inventory table
    ...
    Private Sub btnclear_Click(sender As Object, e As EventArgs) Handles btnclear.Click
        Try
            ...
            Dim sqlDelete As String = "DELETE FROM inventory_movement WHERE MovementDate <= @beforeDate"
