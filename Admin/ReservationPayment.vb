...
Public Class ReservationPayment
    ...
    Private Sub LoadReservationPayments(Optional condition As String = "")
        Try
            ...
            Dim query As String =
        "SELECT 
            rp.ReservationPaymentID AS PaymentID,
            rp.ReservationID,
            r.CustomerID,
            c.FirstName,
            c.LastName,
        ...
        INNER JOIN customer c ON r.CustomerID = c.CustomerID"
            ...
            Dim countQuery As String = "SELECT COUNT(*) FROM reservationpayment rp " &
                                   "INNER JOIN reservation r ON rp.ReservationID = r.ReservationID " &
                                   "INNER JOIN customer c ON r.CustomerID = c.CustomerID"
        ...
        Catch ex As Exception
            MessageBox.Show("Error loading reservation payment: " & ex.Message & vbCrLf & vbCrLf &
    ...
    Private Sub FormatGrid()
        Try
            ...
            If Reservation.Columns.Contains("ReservationDate") Then
                Reservation.Columns("ReservationDate").HeaderText = "Event Date"
                Reservation.Columns("ReservationDate").Width = 100
                Reservation.Columns("ReservationDate").DefaultCellStyle.Format = "MM/dd/yyyy"
                Reservation.Columns("ReservationDate").DisplayIndex = 6
            End If
    ...
    Private Sub btnConfirm_Click(sender As Object, e As EventArgs) Handles btnConfirm.Click
        Try
            ...
            If statusForm.ShowDialog() = DialogResult.OK Then
                ...
                Dim updateQuery As String = $"UPDATE reservationpayment 
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            If result = DialogResult.Yes Then
                Dim deleteQuery As String = $"DELETE FROM reservationpayment 
                                             WHERE ReservationPaymentID = '{paymentID}'"
    ...
    Private Sub btnFirstPage_Click(sender As Object, e As EventArgs) Handles btnFirstPage.Click
        CurrentPage = 1
        LoadReservationPayments(CurrentCondition)
    End Sub
